...
point3d calculateTransform(point3d original,transform transformMatrix){
    point3d retval;
    retval.x=transformMatrix.a11*original.x+transformMatrix.a21*original.y+transformMatrix.a31*original.z;
    retval.y=transformMatrix.a12*original.x+transformMatrix.a22*original.y+transformMatrix.a32*original.z;
    retval.x=transformMatrix.a31*original.x+transformMatrix.a32*original.y+transformMatrix.a33*original.z;
    return retval;
}
